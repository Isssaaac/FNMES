...
namespace FNMES.Entity.Record
{
    ...
    [SugarTable("Record_Test_ELEC_{year}{month}{day}"), LineTableInit]
    //[SugarIndex("index_ELEC_productCode", nameof(ProductCode), OrderByType.Asc)]    //索引
    public class RecordTestElectric
    {
