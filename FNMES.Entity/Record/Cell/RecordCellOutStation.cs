...
namespace FNMES.Entity.Record
{
    ...
    [SugarTable("Record_CellOutStation_{year}{month}{day}")]
    [SugarIndex("index_celloutStation_productCode", nameof(RecordOutStation.ProductCode), OrderByType.Asc), LineTableInit]    //索引
    public class RecordCellOutStation : RecordBase
    {
