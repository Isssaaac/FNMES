...
namespace FNMES.Entity.Record
{
    ...
    [SugarTable("Record_CellPart_{year}{month}{day}"), LineTableInit]
    [SugarIndex("index_cell_part_pid", nameof(RecordCellPartData.PartUploadId), OrderByType.Asc)]    //索引
    [SugarIndex("index_cell_part_partBarcode", nameof(RecordCellPartData.PartBarcode), OrderByType.Asc)]    //索引
    public class RecordCellPartData : RecordBase
    {
        // 主表ID
