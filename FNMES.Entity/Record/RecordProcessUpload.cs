...
namespace FNMES.Entity.Record
{
    ...
    [SugarIndex("index_processUpload_productCode", nameof(RecordProcessUpload.ProductCode), OrderByType.Asc), LineTableInit]    //索引
    public class RecordProcessUpload : RecordBase
    {
        // 内控码
