...
namespace FNMES.Entity.Record
{
    ...
    [SugarTable("Record_BlockProcess_{year}{month}{day}")]
    [SugarIndex("index_block_recordProcess_pid", nameof(RecordBlockProcessData.ProcessUploadId), OrderByType.Asc),LineTableInit]    //索引
    public class RecordBlockProcessData: RecordBase
    {
        // 主表ID
