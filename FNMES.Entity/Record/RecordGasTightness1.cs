...
namespace FNMES.Entity.Record
{
    ...
    [SugarTable("Record_GasTightness1_{year}{month}{day}")]
    //[SugarIndex("index_GasTightness1_productCode", nameof(ProductCode), OrderByType.Asc)]    //索引
    public class RecordGasTightness1
    {
