...
namespace FNMES.Service.WebService.FN
{
    
    public class WebServiceContract_FN
    {
        ...
        public RetMessage<LabelAndOrderData> GetLabel(GetLabelParam param, string configId)
        {
            ...
            if (param.requestCodeType == "packNo" || true)
            {
                ...
                GetLabelData getLabelData = new GetLabelData();
                getLabelData.codeContent = barcode;

                RetMessage<GetLabelData> apiRet = new RetMessage<GetLabelData>();
                apiRet.data = getLabelData;
