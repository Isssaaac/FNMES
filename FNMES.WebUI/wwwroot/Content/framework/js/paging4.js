...
layui.define(['layer', 'laypage', 'form', 'laytpl'], function (exports) {
     ...
     * 版本号
     */
    Paging4.prototype.v = '1.0.1';

    /**
	 * 设置
	 * @param {Object} options
	 */
    Paging4.prototype.set = function (options) {
        var that = this;
	 ...
	 * @param {Object} options
	 */
    Paging4.prototype.init = function (options) {
        var that = this;
        $.extend(true, that.config, options);
	 ...
	 * @param {Object} options
	 */
    Paging4.prototype.get = function (options) {
        var that = this;
        var _config = that.config;
    ...
    var paging4 = new Paging4();
    exports('paging4', function (options) {
        return paging4.set(options);
    });
});