    ...
    function getHtml(data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            if (data[i].children !== undefined && data[i].children.length > 0) {
                ...
                ulHtml += '<cite style="-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;">' + data[i].title + '</cite>'
                ulHtml += '</a>';
                ...
                for (var j = 0; j < data[i].children.length; j++) {
                    ...
                    ulHtml += '<cite style="-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;">' + data[i].children[j].title + '</cite>';
                    ulHtml += '</a>';
                    ulHtml += '</dd>';
                }
                ulHtml += '</dl>';
            } else {
                var dataUrl = (data[i].href != null && data[i].href !== undefined && data[i].href !== '') ? 'data-url="' + data[i].href + '"' : '';
