...
layui.define(['layer', 'laypage', 'form', 'laytpl'], function (exports) {
     ...
     * 版本号
     */
    Paging2.prototype.v = '1.0.1';

    /**
	 * 设置
	 * @param {Object} options
	 */
    Paging2.prototype.set = function (options) {
        var that = this;
	 ...
	 * @param {Object} options
	 */
    Paging2.prototype.init = function (options) {
        var that = this;
        $.extend(true, that.config, options);
	 ...
	 * @param {Object} options
	 */
    Paging2.prototype.get = function (options) {
        var that = this;
        var _config = that.config;
    ...
    var paging2 = new Paging2();
    exports('paging2', function (options) {
        return paging2.set(options);
    });
});