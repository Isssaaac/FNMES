...
layui.define(['layer', 'laypage', 'form', 'laytpl'], function (exports) {
     ...
     * 版本号
     */
    Paging3.prototype.v = '1.0.1';

    /**
	 * 设置
	 * @param {Object} options
	 */
    Paging3.prototype.set = function (options) {
        var that = this;
	 ...
	 * @param {Object} options
	 */
    Paging3.prototype.init = function (options) {
        var that = this;
        $.extend(true, that.config, options);
	 ...
	 * @param {Object} options
	 */
    Paging3.prototype.get = function (options) {
        var that = this;
        var _config = that.config;
    ...
    var paging3 = new Paging3();
    exports('paging3', function (options) {
        return paging3.set(options);
    });
});